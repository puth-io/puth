...
//
//     // useEffect(() => {
//     //     if (containerRef.current && app.activeContext?.followIncoming) {
//     //         containerRef.current.scrollTop = containerRef.current.scrollHeight;
//     //     }
//     // }, [app.activeContext?.renderedEvents]);
//
//     if (! app.activeContext) {
//         return <></>;
//     }
...
//             if (! app.activeContext.followIncoming) {
//                 console.log('follow bottom');
//                 app.activeContext.followIncoming = true;
//             }
//         } else {
//             if (app.activeContext.followIncoming) {
//                 console.log('unfollow bottom');
//                 app.activeContext.followIncoming = false;
//             }
//         }
//     };
...
//                 className={'grow overflow-y-auto px-5'}
//                 onScroll={event => {
//                     app.activeContext.followIncoming ? onScroll(event) : onScrollDebounced(event);
//                 }}
//             >
//                 <table className={'table-auto w-full context-event-table'} style={{margin: '-4px 0'}}>
//                     <tbody className={''}>
