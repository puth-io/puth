...
docker container stop puth-local-fresh-laravel || true
docker container rm puth-local-fresh-laravel || true
docker run -dit --name=puth-local-fresh-laravel --network host --workdir=/work/php/workspaces/laravel/ laravelphp/vapor:php82 ash
docker container cp workspaces/clients/php/ puth-local-fresh-laravel:/work
docker container exec puth-local-fresh-laravel ash -c "chown -R root:root /work"
